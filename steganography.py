...
def main():
    ...
    secret = lsb.hide(".\encode.png","hiiii")
    secret.save(".\encode_text.png")
    lsb.reveal(".\encode_text.png")
    a = lsb.reveal(".\encode_text.png")
    print(a)
    
    
    
    img3 = ".\encode_text.png"
    img4 = ".\hide1.png"
    #this is the path where we will save the encoded Image.
    output1 = ".\encode1.png"
